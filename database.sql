...
VALUES ('A work of art which did not begin in emotion is not art.', 'Paul Cezanne', 'true'),
	   ...
	   ('Every day is truly a beautiful day, if you know how to look at it.', 'Miss Shyla Ann', 'true');
...
VALUES('Checkout the texture and form. What might you do different?', 'link', 'image', null, 1, 'true'),
	  ('What may have inspired the artist to use this paricular medium?', 'link', 'image', 1, null, 'true'),
	  ('Watch this video on using bronze to create sculptures.', 'https://www.youtube.com/watch?v=yNcbdspjCeM', 'image', 4, null, 'true'),
	  ('Although this is not a kinetic sculpture, it gives the sense of movement. What aspects of the sculpture create this sense of movement?', null, null, 5, null, 'true'),
	  ('Look closely at the glass fish, what does it make you think of? How do you think they were they created?', null, null, 5, null, 'true'),
	  ('Look at the variety of fish in this sculpture. How many of each can you find?', null, null, 5, null, 'true'),
	  ('Look into the face of the figure. See yourself reflected there.', null, null, 6, null, 'true'),
	  ('Learn about the history of bronze.', 'https://www.youtube.com/watch?v=W8GmKJXoTO8', null, 6, null, 'true'),
	  ('Look closely at the construction of each block. How do you think they are assembled? How much do you guess it would weigh?', null, null, 7, null, 'true'),
	  ('How do you think the large scale child''s letter blocks impacts the power or meaning of this sculpture?', null, null, 7, null, 'true'),
	  ('Look closely at the sculpture from different angles. Which is your favorite viewpoint and why?', null, null, 8, null, 'true'),
	  ('Visit this sculpture at different times of day. How does the intensity of the colors change and move throughout the day?', null, null, 8, null, 'true'),
	  ('Look closely at the relief sculptures that make up the Faces of Rondo. Compare and contrast these Community Portraits with the relief sculptures you have surely seen donning exterior walls and doorways of government and religious buildings.', null, null, 8, null, 'true'),
	  ('Take out a US coin and study the bas relief. Consider the face on the coin and those in Faces of Rondo. How are their contributions to our country similar and different?', null, null, 9, null, 'true'),
	  ('Watch a two minute video of artist Eugene Daub creating a bas relief portrait!', 'https://www.youtube.com/watch?v=6HVdhBHCH5Q', null, 9, null, 'true'),('Watch an interview with artist Caprice Glaser and hear about what she calls the mystery and spontaneity of art.', 'https://www.youtube.com/watch?v=yUNX45J0v48', 'image', 10, null, 'true'),
	  ('Watch this video for step by step crane folding directions...Fold along!', 'https://www.youtube.com/watch?v=yTY-nGYYq_c', 'image', 10, null, 'true'),
	  ('Notice the scale, geometric planes and the intense blue color that make up bear. How do you think these aspects help to create the mood of this sculpture?', null, null, 11, null, 'true'),
	  ('What feeling would this sculpture evoke if it was realistic in size, color and texture? Would it have become a city icon?', null, null, 11, null, 'true'),
	  ('Study the three Peacocks. Compare and contrast them. What Story do they tell?', null, null, 13, null, 'true'),
	  ('A triptych is a set of three associated artistic, literary, or musical works intended to be appreciated together. Would you consider these a triptych?', null, null, 13, null, 'true'),
	  ('Did you know that the Peacock is the national bird of India? Check it out!', null, null, 13, null, 'true'),
	  ('Look closely at the sculpture which was erected in 1912. Find ways that it has been impacted by its 100+ years. How has it maintained it''s original beauty?', null, null, 14, null, 'true'),
	  ('Can you tell how this was created by looking at the details?', null, null, 15, null, 'true'),
	  ('Notice the lines created by the steel rods in these sculptures. How do the lines help to describe the energy of the horses? How would the sculpture feel if the lines were all horizontal or vertical?', null, null, 15, null, 'true'),
	  ('Look closely at this sculpture at the variety of shapes and textures.', null, null, 16, null, 'true'),
	  ('Hear why the artist got started making Humpty sculpture!', 'https://www.youtube.com/watch?v=bqCUxolXsWg', null, 17, null, 'true'),
	  ('Look at the expression on Egghead''s face. What does that tell you about his personality? What else can you learn from studying him?', null, null, 17, null, 'true'),
	  ('Notice the outfits the family wears. How does our current culture dress for air travel?', null, null, 18, null, 'true'),
	  ('The artist Nick Legeros has made many sculptures in the Twin Cities. His Goldy Gopher at the University of MN is beloved. Watch the video to learn about the steps to get Goldy from a clay design to a bronze sculpture.', null, null, 19, null, 'true');
