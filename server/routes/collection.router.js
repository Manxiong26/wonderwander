...
console.log('CHECKING THE ID', req.params);
    ...
    collection.donate_link, collection.site_link, collection.search_text, artwork."name" AS artwork_name, 
    artwork."year" AS artwork_year, artwork."lat/long", artwork.image AS artwork_image, 
